package com.kunbo.app.view.lemonbubble;
...
import com.kunbo.app.view.lemonbubble.enums.LemonBubbleLayoutStyle;
import com.kunbo.app.view.lemonbubble.interfaces.LemonBubblePaintContext;
 ...
 * <p>
 * 自定义样式的话，需要新建一个LemonBubbleInfo对象，然后对其进行修改属性即可
 ...
 * myInfo.setLayoutStyle(LemonBubbleLayoutStyle.ICON_LEFT_TITLE_RIGHT); //设置图标在左侧，标题在右侧
 * myInfo.setLocationStyle(LemonBubbleLocationStyle.BOTTOM);// 设置泡泡控件在底部
 * myInfo.setIconColor(Color.BLUE);// 设置泡泡控件的动画图标颜色为蓝色
 * myInfo.setBubbleSize(200,80);// 设置泡泡控件的尺寸，单位dp
 * myInfo.setProportionOfDeviation(0.01f);// 设置泡泡控件的偏移比例为整个屏幕的0.01
 * myInfo.setTitle("自定义泡泡控件");// 设置泡泡控件的标题
 * LemonBubble.showBubbleInfo(this,myInfo,2000);// 展示自定义的泡泡控件，并显示2s后关闭
 */
public class LemonBubble {
     ...
     * @param title    显示的标题
     */
    public static void showRight(androidx.fragment.app.Fragment fragment, String title) {
        LemonBubbleInfo bubbleInfo = getRightBubbleInfo();
        bubbleInfo.setTitle(title);
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo);
    }
     ...
     * @param autoCloseTime 自动关闭的时间，单位ms
     */
    public static void showRight(androidx.fragment.app.Fragment fragment, String title, int autoCloseTime) {
        LemonBubbleInfo bubbleInfo = getRightBubbleInfo();
        bubbleInfo.setTitle(title);
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo, autoCloseTime);
    }
     ...
     * @param title    显示的标题
     */
    public static void showError(androidx.fragment.app.Fragment fragment, String title) {
        LemonBubbleInfo bubbleInfo = getErrorBubbleInfo();
        bubbleInfo.setTitle(title);
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo);
    }
     ...
     * @param autoCloseTime 自动关闭的时间，单位ms
     */
    public static void showError(androidx.fragment.app.Fragment fragment, String title, int autoCloseTime) {
        LemonBubbleInfo bubbleInfo = getErrorBubbleInfo();
        bubbleInfo.setTitle(title);
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo, autoCloseTime);
    }
    ...
    public static LemonBubbleInfo getRoundProgressBubbleInfo() {
        final LemonBubbleInfo info = new LemonBubbleInfo();
        info.setBubbleSize(120, 120);
        info.setMaskColor(Color.argb(50, 0, 0, 0));//背景遮罩色
        info.setIconColor(Color.argb(255, 29, 145, 29));
        info.setBackgroundColor(Color.argb(0, 0, 0, 0));//进度条背景色
     ...
     * @return 带有无限循环转动的等待提示信息的泡泡信息对象
     */
    public static void showRoundProgress(androidx.fragment.app.Fragment fragment, String title) {
        LemonBubbleInfo bubbleInfo = getRoundProgressBubbleInfo();
        bubbleInfo.setTitle(title);
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo);
    }
     ...
     * @param bubbleInfo 泡泡信息描述对象
     */
    public static void showBubbleInfo(androidx.fragment.app.Fragment fragment, LemonBubbleInfo bubbleInfo) {
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo);
    }
     ...
     * @param autoCloseTime 自动关闭的时间
     */
    public static void showBubbleInfo(androidx.fragment.app.Fragment fragment, LemonBubbleInfo bubbleInfo, int autoCloseTime) {
        LemonBubbleView.defaultBubbleView().showBubbleInfo(fragment, bubbleInfo, autoCloseTime);
    }
