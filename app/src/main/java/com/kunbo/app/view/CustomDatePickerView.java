...
public class CustomDatePickerView extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<CustomDatePickerView> mWeakView;

        private ScrollHandler(CustomDatePickerView view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            CustomDatePickerView view = mWeakView.get();
            if (view == null) return;
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.title_blue);
        mDarkColor = ContextCompat.getColor(mContext, R.color.gray_23);
    }
