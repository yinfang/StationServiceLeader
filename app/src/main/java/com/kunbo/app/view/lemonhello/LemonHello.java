package com.kunbo.app.view.lemonhello;
...
import com.kunbo.app.view.lemonhello.enums.LemonHelloIconLocation;
import com.kunbo.app.view.lemonhello.interfaces.LemonPaintContext;

/**
 * LemonHello 对话框实际应用类
 * LemonHello.getWarningHello().show
 * LemonHello.getInformationHello().show
 * LemonHello.getErrorHello().show
 * LemonHello.getSuccessHello().show
 * <p>
 * 默认添加action使用示例：
 * LemonHello.getSuccessHello("提示", "恭喜您，集成成功！")
 * .addAction(new LemonHelloAction("我知道啦", new LemonHelloActionDelegate() {
 * @Override public void onClick(LemonHelloView helloView, LemonHelloInfo helloInfo, LemonHelloAction helloAction) {
 * helloView.hide();
 * } })) .show(this);
 * <p>
 * 自定义对话框使用示例：
 ...
 * @Override public void onClick(LemonHelloView helloView, LemonHelloInfo
