...
import com.kunbo.app.view.lemonbubble.enums.LemonBubbleLocationStyle;
import com.kunbo.app.view.lemonbubble.interfaces.LemonBubbleMaskOnTouchContext;
import com.kunbo.app.view.lemonbubble.interfaces.LemonBubblePaintContext;
import com.kunbo.app.view.lemonbubble.interfaces.LemonBubbleProgressModePaintContext;
...
public class LemonBubbleInfo {
     ...
     * @param autoCloseTime 自动关闭的时间
     */
    public void show(androidx.fragment.app.Fragment fragment, int autoCloseTime) {
        LemonBubble.showBubbleInfo(fragment, this, autoCloseTime);
    }
